...
func NewExecutionEngine(container interfaces.ICodeContainer, crypto interfaces.ICrypto, table interfaces.ICodeTable, service IInteropService, gas int64) *ExecutionEngine {
...
func (e *ExecutionEngine) Create(caller Uint160, code []byte) ([]byte, error) {
	return code, nil
}

func (e *ExecutionEngine) Call(caller Uint160, codeHash Uint160, input []byte) ([]byte, error) {
...
func (e *ExecutionEngine) getPriceForSysCall() int64 {
	...
	switch name {
	case "Blockchain.GetHeader":
		return 100
	case "Blockchain.GetBlock":
		return 200
	case "Blockchain.GetTransaction":
		return 100
	case "Blockchain.GetAccount":
		return 100
	case "Blockchain.RegisterValidator":
		return 1000 * 100000000 / ratio
	case "Blockchain.GetValidators":
		return 200
	case "Blockchain.CreateAsset":
		return 5000 * 100000000 / ratio
	case "Blockchain.GetAsset":
		return 100
	case "Blockchain.CreateContract":
		return 500 * 100000000 / ratio
	case "Blockchain.GetContract":
		return 100
	case "Transaction.GetReferences":
		return 200
	case "Asset.Renew":
