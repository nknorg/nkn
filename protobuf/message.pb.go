...
func (MessageType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_message_fd565f89a3cc7fa3, []int{0}
}

type UnsignedMessage struct {
	MessageType MessageType `protobuf:"varint,1,opt,name=message_type,json=messageType,proto3,enum=protobuf.MessageType" json:"message_type,omitempty"`
...
func (*SignedMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_message_fd565f89a3cc7fa3, []int{1}
}
...
func (*Vote) Descriptor() ([]byte, []int) {
	return fileDescriptor_message_fd565f89a3cc7fa3, []int{2}
}
...
func init() {
	proto.RegisterType((*UnsignedMessage)(nil), "protobuf.UnsignedMessage")
	proto.RegisterType((*SignedMessage)(nil), "protobuf.SignedMessage")
	proto.RegisterType((*Vote)(nil), "protobuf.Vote")
...
func (this *UnsignedMessage) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&protobuf.UnsignedMessage{")
...
func (this *SignedMessage) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&protobuf.SignedMessage{")
	s = append(s, "Message: "+fmt.Sprintf("%#v", this.Message)+",\n")
...
func NewPopulatedUnsignedMessage(r randyMessage, easy bool) *UnsignedMessage {
	...
	this.MessageType = MessageType([]int32{0}[r.Intn(1)])
	v1 := r.Intn(100)
...
func init() { proto.RegisterFile("protobuf/message.proto", fileDescriptor_message_fd565f89a3cc7fa3) }

var fileDescriptor_message_fd565f89a3cc7fa3 = []byte{
	// 284 bytes of a gzipped FileDescriptorProto
	,
	...
	0xc3, 0x85, 0xc7, 0x72, 0x0c, 0x37, 0x1e, 0xcb, 0x31, 0x24, 0xb1, 0x81, 0x03, 0xc3, 0x18, 0x10,
	0x00, 0x00, 0xff, 0xff, 0x74, 0x29, 0xe4, 0xfd, 0x90, 0x01, 0x00, 0x00,
}
