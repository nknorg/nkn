...
func (WinnerType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_header_cdfe063a26b83f9b, []int{0}
}
...
type BlockHeader struct {
	...
	Programs       *Program        `protobuf:"bytes,3,opt,name=Programs" json:"Programs,omitempty"`
}

func (m *BlockHeader) Reset()      { *m = BlockHeader{} }
func (*BlockHeader) ProtoMessage() {}
func (*BlockHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_header_cdfe063a26b83f9b, []int{1}
}
...
func (m *BlockHeader) GetPrograms() *Program {
	if m != nil {
		return m.Programs
	}
	return nil
...
func (this *BlockHeader) Equal(that interface{}) bool {
	...
	if !this.Programs.Equal(that1.Programs) {
		return false
	}
	return true
}
...
func (m *BlockHeader) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Programs != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintHeader(dAtA, i, uint64(m.Programs.Size()))
		n2, err := m.Programs.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n2
...
func (m *BlockHeader) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if err := m.Programs.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func init() { proto.RegisterFile("header.proto", fileDescriptor_header_cdfe063a26b83f9b) }

var fileDescriptor_header_cdfe063a26b83f9b = []byte{
	// 477 bytes of a gzipped FileDescriptorProto
	,
}
