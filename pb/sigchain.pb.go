...
func (SigAlgo) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_sigchain_d7177f50d19dee1d, []int{0}
}
...
func (*SigChain) Descriptor() ([]byte, []int) {
	return fileDescriptor_sigchain_d7177f50d19dee1d, []int{1}
}
...
func init() { proto.RegisterFile("pb/sigchain.proto", fileDescriptor_sigchain_d7177f50d19dee1d) }

var fileDescriptor_sigchain_d7177f50d19dee1d = []byte{
