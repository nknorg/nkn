...
func (SigAlgo) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_sigchain_88a6ba8fc5102507, []int{0}
}
...
func (*SigChain) Descriptor() ([]byte, []int) {
	return fileDescriptor_sigchain_88a6ba8fc5102507, []int{1}
}
...
func init() { proto.RegisterFile("pb/sigchain.proto", fileDescriptor_sigchain_88a6ba8fc5102507) }

var fileDescriptor_sigchain_88a6ba8fc5102507 = []byte{
