...
func (SigAlgo) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_sigchain_6200bdf7ec125305, []int{0}
}
...
func (*SigChain) Descriptor() ([]byte, []int) {
	return fileDescriptor_sigchain_6200bdf7ec125305, []int{1}
}
...
func init() { proto.RegisterFile("pb/sigchain.proto", fileDescriptor_sigchain_6200bdf7ec125305) }

var fileDescriptor_sigchain_6200bdf7ec125305 = []byte{
