...
func (SyncState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_node_83658353439bb1aa, []int{0}
}
...
func init() { proto.RegisterFile("pb/node.proto", fileDescriptor_node_83658353439bb1aa) }

var fileDescriptor_node_83658353439bb1aa = []byte{
