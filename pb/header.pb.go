...
func (WinnerType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_header_c79a03d9a6fd7868, []int{0}
}
...
func (*BlockHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_header_c79a03d9a6fd7868, []int{1}
}
...
func (m *UnsignedHeader) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.RandomBeacon) > 0 {
		dAtA[i] = 0x3a
		i++
		i = encodeVarintHeader(dAtA, i, uint64(len(m.RandomBeacon)))
...
func init() { proto.RegisterFile("pb/header.proto", fileDescriptor_header_c79a03d9a6fd7868) }

var fileDescriptor_header_c79a03d9a6fd7868 = []byte{
	// 488 bytes of a gzipped FileDescriptorProto
	,
}
