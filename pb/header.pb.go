...
func (WinnerType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_header_038a1a7ed995d8b0, []int{0}
}
...
type UnsignedHeader struct {
	...
	NextBookKeeper   []byte     `protobuf:"bytes,8,opt,name=next_book_keeper,json=nextBookKeeper,proto3" json:"next_book_keeper,omitempty"`
	WinnerHash       []byte     `protobuf:"bytes,9,opt,name=winner_hash,json=winnerHash,proto3" json:"winner_hash,omitempty"`
	WinnerType       WinnerType `protobuf:"varint,10,opt,name=winner_type,json=winnerType,proto3,enum=pb.WinnerType" json:"winner_type,omitempty"`
	Signer           []byte     `protobuf:"bytes,11,opt,name=signer,proto3" json:"signer,omitempty"`
	ChordId          []byte     `protobuf:"bytes,12,opt,name=chord_id,json=chordId,proto3" json:"chord_id,omitempty"`
}
...
func (*BlockHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_header_038a1a7ed995d8b0, []int{1}
}
...
func init() { proto.RegisterFile("pb/header.proto", fileDescriptor_header_038a1a7ed995d8b0) }

var fileDescriptor_header_038a1a7ed995d8b0 = []byte{
	// 538 bytes of a gzipped FileDescriptorProto
	,
}
